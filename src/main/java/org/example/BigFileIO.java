...
public class BigFileIO {
    ...
    public void aio() throws IOException {
        String filePath = "C:\\Users\\nilknow\\IdeaProjects\\demo-interview\\src\\main\\resources\\big_file.txt";
    ...
    public void blockReading() throws IOException {
        ClassLoader classLoader = BigFileIO.class.getClassLoader();

        // Get the file path
        String filePath = "big_file.txt";
    ...
    public static void main(String[] args) throws RunnerException {
        final Options opts = new OptionsBuilder()
                .include(BigFileIO.class.getSimpleName())
                .forks(1)
